...
public class DressmakerTest {
    ...
    public void should_tailor_to_a_T_shirt_when_given_red_needlework_with_display() {
        String size = "XL";
        // Given
    ...
    @Test
    @DisplayName("should tailor to a  T-shirt when given red needlework")
    public void should_tailor_to_a_T_shirt_when_given_red_needlework_with_display_en() {
        String size = "XL";
        // Given
        Dressmaker dressmaker = new Dressmaker("Andy");
        // When
    ...
    @Test
    public void shouldTailorToA_TShirtWhenGivenRedNeedlework() {
        String size = "XL";
        // Given
        Dressmaker dressmaker = new Dressmaker("Andy");
        // When
